            ...
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                if (!context.Movies.Any())
                {
                    context.Movies.AddRange(new List<Movie>()
                    {
                        ...
                        {
                            Name= "Life",
                            Description="This is the description of life movie",
                            Price= 39.50,
                        ...
                        new Movie()
                        {
                            ...
                            Description="This is the description of The shawshank Redemption movie",
                            Price= 29.50,
                        ...
                        {
                            Name= "Ghost",
                            Description="This is the description of Ghost movie",
                            Price= 29.50,
                        ...
                        {
                            Name= "Race",
                            Description="This is the description of race movie",
                            Price= 29.50,
                        ...
                        {
                            Name= "Scoob",
                            Description="This is the description of scoob movie",
                            Price= 29.50,
                        ...
                        {
                            Name= "Cold Soles",
                            Description="This is the description of Cold Soles movie",
                            Price= 29.50,
